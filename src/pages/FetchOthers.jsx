...
const FetchOthers = () => {
  ...
  return (
    <div className="dout">
      ...
      {pn.map((pateintName, index) => (
        <h5 key={index}>{pateintName}</h5>
      ))}{" "}
      -{" "}
      {pa.map((pateintAddress, index) => (
        <h5 key={index}>{pateintAddress}</h5>
      ))}
      <h6>{}</h6>
      {displayDetails ? (
        <div>
            ...
            <table>
              ...
              <tbody>
                <tc>
                  ...
                  <tr className="tr">
                    <td className="tdd">
                      Blood Pressure : {dia[1]}
                      <hr />
                    </td>
                  </tr>
                  <tr className="tr">
                    <td className="tdd">
                      Skin Thickness :{dia[2]}
                      <hr />
                    </td>
                  </tr>
                  <tr className="tr">
                ...
                <tc>
                  ...
                  <tr className="tr">
                    <td className="tdd">
                      Diabetes Pedigree Function : {dia[6]}
                      <hr />
                    </td>
                  </tr>
                </tc>
            ...
            <table>
              ...
              <tbody>
                <tc>
                  <tr className="tr">
                    <td className="tdd">
                      Chest-pain type : {hd[0]}
                      <hr />
                    </td>
                  </tr>
                  <tr className="tr">
                    <td className="tdd">
                      Resting Blood Pressure : {hd[1]}
                      <hr />
                    </td>
                  </tr>
                  <tr className="tr">
                    <td className="tdd">
                      Max heart rate achieved : {hd[2]}
                      <hr />
                    </td>
                  </tr>
                  <tr className="tr">
                    <td className="tdd">
                      Serum Cholestrol : {hd[3]}
                      <hr />
                    </td>
                  </tr>
                </tc>
